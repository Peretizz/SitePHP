...
<body class="bg-dark">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="form_filme.php" style="color: #f7d1ba"> Cadastro Filmes</a>
                            </li>
                            <li class="nav-item">
    ...
    <main class="w-75 mt-1 m-auto">
        <div class="card bg-dark text-white border border-secondary p-4">
            <h2 class="text-center mb-4" style="color: #f7d1ba">Cadastro de Filmes</h2>
            <form action="cadastro-filme.php" class="row g-3" method="POST" enctype="multipart/form-data">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="elenco" placeholder="Digite o Elenco do Filme" required>
                </div>
                <div class="col-md-6">
